...
def mostrar_resultados(totales, contenedores, mensajes_contenedores, df_filtrado, columnas_mapeadas):
    ...
    tree = ttk.Treeview(frame_contenedores, columns=("Peso"), show="headings", height=10)
    ...
    tk.Button(root, text="Exportar a Excel", command=lambda: exportar_a_excel(contenedores, mensajes_contenedores, df_filtrado, columnas_mapeadas)).pack(pady=10)
